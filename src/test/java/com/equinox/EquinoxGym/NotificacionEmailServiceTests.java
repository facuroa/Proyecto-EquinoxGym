...
class NotificacionEmailServiceTests {
    ...
    void noHaceNadaCuandoElFlagEstaApagado() {
        NotificacionEmailService servicio = new NotificacionEmailService(null, null, null, null, false, "Keep Fit Gym", "http://localhost:8085");
    ...
    void noHaceNadaSiElSocioNoTieneEmailAunConElFlagEncendido() {
        NotificacionEmailService servicio = new NotificacionEmailService(null, null, null, null, true, "Keep Fit Gym", "http://localhost:8085");
